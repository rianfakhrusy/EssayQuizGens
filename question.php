...
/**
 * Essay question for quiz generator definition class.
...
/**
 * Represents an essay question for quiz generator.
 * Extended from The Open University's essay question code (2009).
 *
 * @copyright  2017 Rian Fakhrusy
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_essayquizgens_question extends question_with_responses {
     ...
     * @return qtype_essayquizgens_format_renderer_base the response-format-specific renderer.
     */
    public function get_format_renderer(moodle_page $page) {
        return $page->get_renderer('qtype_essayquizgens', 'format_' . $this->responseformat);
    }
    ...
    public function check_file_access($qa, $options, $component, $filearea, $args, $forcedownload) {
        ...
        } else if ($component == 'qtype_essayquizgens' && $filearea == 'graderinfo') {
