...
/**
 * Essay question for quiz generator renderer class.
...
/**
 * Generates the output for essay questions for quiz generator.
 * Extended from The Open University's essay question code (2009).
 *
 * @copyright  2017 Rian Fakhrusy
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_essayquizgens_renderer extends qtype_renderer {
    ...
    public function manual_comment(question_attempt $qa, question_display_options $options) {
        ...
        return html_writer::nonempty_tag('div', $question->format_text(
                $question->graderinfo, $question->graderinfo, $qa, 'qtype_essayquizgens',
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class qtype_essayquizgens_format_renderer_base extends plugin_renderer_base {
    /**
 ...
 * any inline response.
 * Extended from The Binghamton University's essay question code (2013).
 *
 * @copyright  2017 Rian Fakhrusy
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_essayquizgens_format_noinline_renderer extends plugin_renderer_base {

    protected function class_name() {
        return 'qtype_essayquizgens_noinline';
    }
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_essayquizgens_format_editor_renderer extends plugin_renderer_base {
    protected function class_name() {
        return 'qtype_essayquizgens_editor';
    }

    public function response_area_read_only($name, $qa, $step, $lines, $context) {
        return html_writer::tag('div', $this->prepare_response($name, $qa, $step, $context),
                array('class' => $this->class_name() . ' qtype_essayquizgens_response readonly'));
    }
    ...
    public function response_area_input($name, $qa, $step, $lines, $context) {
        ...
        $output .= html_writer::start_tag('div', array('class' =>
                $this->class_name() . ' qtype_essayquizgens_response'));
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_essayquizgens_format_editorfilepicker_renderer extends qtype_essay_format_editor_renderer {
    protected function class_name() {
        return 'qtype_essayquizgens_editorfilepicker';
    }
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_essayquizgens_format_plain_renderer extends plugin_renderer_base {
    /**
     * @return string the HTML for the textarea.
     */
    protected function textarea($response, $lines, $attributes) {
        $attributes['class'] = $this->class_name() . ' qtype_essayquizgens_response';
    ...
    protected function class_name() {
        return 'qtype_essayquizgens_plain';
    }
 ...
 * Extended from The Open University's essay question code (2009).
 *
 * @copyright  2017 Quiz Generator
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_essayquizgens_format_monospaced_renderer extends qtype_essay_format_plain_renderer {
    protected function class_name() {
        return 'qtype_essayquizgens_monospaced';
    }
}
