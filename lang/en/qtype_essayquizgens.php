...
/**
 * Strings for component 'qtype_essayquizgens', language 'en', branch 'MOODLE_20_STABLE'
 * Extended from Martin Dougiamas's essay question code (1999 onwards).
 *
 * @package    qtype
 * @subpackage essayquizgens
 * @copyright  2007 Rian Fakhrusy
...
$string['pluginname'] = 'Essay for Quiz Generator';
...
$string['pluginname_link'] = 'question/type/essayquizgens';
$string['pluginnameadding'] = 'Adding an Essay question';
$string['pluginnameediting'] = 'Editing an Essay question';
$string['pluginnamesummary'] = 'Allows a response of a few sentences or paragraphs. This must then be graded manually. Question type for Quiz Generator plug-in';
